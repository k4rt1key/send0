        ...
        if (!this.isNew) {
            ...
            if (this.files.length !== 0) {
                for (let i = 0; i < this.files.length; i++) {
                    const presignedUrl = (yield (0, awsS3_1.generatePresignedUrlForGetObject)(this.files[i].name, this.expiryTime)) || '';
...
const UploadModel = mongoose_1.default.model('Upload', UploadSchema);
